...
- [ ] remove PROVINCE_ID from front matter - province is part of the directory structure
...
- From current main, re-extract images, recreate gre-images, gre-no-images
  (be sure to keep CSS edits, image shortcode, etc. from old gre-no-images)
